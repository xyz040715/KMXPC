<?xml version="1.0" encoding="utf-8"?><Profile xmlns="http://soap.sforce.com/2006/04/metadata"><custom>true</custom><description>Integration accounts that only require Read Access.</description><userLicense>Salesforce</userLicense><userPermissions>
