<?xml version="1.0" encoding="utf-8"?><Profile xmlns="http://soap.sforce.com/2006/04/metadata"><custom>true</custom><description>Non-SSO System Administrator account that will not be assigned to users in Production. It will be assigned to Platform Support users in sub-Production orgs during Sandbox refreshes to allow them to configure SSO settings.</description><userLicense>Salesforce</userLicense><userPermissions>
